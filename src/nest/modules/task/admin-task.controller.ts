...
export class AdminTaskController {
  ...
  async assign(@Body() body: { taskId: number; userIds: number[] }) {
  ...
  async revokeAssign(@Body() body: { taskId: number; userIds: number[] }) {
...
export class AdminTaskStatisticsController {
  ...
  @UseGuards(PermissionsGuard)
  @RequirePermissions('system:task:list')
  async export(@Body() body: { type?: 'overview' | 'claims' | 'tasks' }) {

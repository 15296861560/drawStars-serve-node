...
const MENU_SEEDS: MenuSeed[] = [
  ...
  { key: "manage_task_overview", parentKey: "manage_task", name: "任务概览", type: 2, path: "/home/manageHomePage/task/overview", permission: "system:task:list", icon: "DataAnalysis", sort: 1 },
  { key: "manage_task_list", parentKey: "manage_task", name: "任务列表", type: 2, path: "/home/manageHomePage/task/list", permission: "system:task:list", icon: "Document", sort: 2 },
  { key: "manage_task_audit", parentKey: "manage_task", name: "任务审核", type: 2, path: "/home/manageHomePage/task/audit", permission: "system:task:audit", icon: "Checked", sort: 3 },
  { key: "manage_task_shipping", parentKey: "manage_task", name: "奖励发放", type: 2, path: "/home/manageHomePage/task/shipping", permission: "system:task:operate", icon: "Van", sort: 4 },
  { key: "manage_task_view", parentKey: "manage_task", name: "查看任务", type: 3, permission: "system:task:list", sort: 11 },
  { key: "manage_task_operate", parentKey: "manage_task", name: "任务操作", type: 3, permission: "system:task:operate", sort: 12 },
  { key: "manage_task_audit_btn", parentKey: "manage_task", name: "任务审核", type: 3, permission: "system:task:audit", sort: 13 },
  {
    key: "manage_notice",
    parentKey: "manage",
    name: "通知管理",
